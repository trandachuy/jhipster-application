...
@RestController
@RequestMapping("/api/jhipster-application-kafka")
public class JhipsterApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterApplicationKafkaResource.class);
    ...
    public JhipsterApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
